...
(function ($, document, window, undefined) {
    ...
    $.fn.pagepiling = function (custom) {
        ...
        //BE CAREFUL! Not recommened to change it under 400 for a good behavior in laptops and Apple devices (laptops, mouses...)
        var scrollDelay = 1200; //600 1200
        ...
        $('.pp-section').each(function(index){
			...
			scrollToAnchor(); //신규추가(해쉬 태그 로딩시 이전 페이지 로딩 안되게)
        ...
        //Gets the property used to create the scrolling effect when using jQuery animations depending on the plugin direction option.
		...
		if(navigator.appVersion.indexOf("MSIE 7.") != -1){
			$(".update_menu a").click(function(e){
				e.preventDefault();
			});
			$(".update_menu .m1 > a").click(function(){
				scrollPage($('.pp-section').eq(0));
			});
			$(".update_menu .m2 a").click(function(){
				scrollPage($('.pp-section').eq(1));
			});
			$(".update_menu .m3 > a, .update_menu .m3 .depth2:eq("+0+")").click(function(){
				scrollPage($('.pp-section').eq(2));
			});
			$(".update_menu .m3 .depth2:eq("+1+")").click(function(){
				scrollPage($('.pp-section').eq(3));
			});
			$(".update_menu .m4 > a, .update_menu .m4 .depth2:eq("+0+")").click(function(){
				scrollPage($('.pp-section').eq(4));
			});
			$(".update_menu .m4 .depth2:eq("+1+")").click(function(){
				scrollPage($('.pp-section').eq(5));
			});
			$(".update_menu .m4 .depth2:eq("+2+")").click(function(){
				scrollPage($('.pp-section').eq(6));
			});
			$(".update_menu .m5 > a, .update_menu .m5 .depth2:eq("+0+")").click(function(){
				scrollPage($('.pp-section').eq(7));
			});
			$(".update_menu .m6 > a, .update_menu .m6 .depth2:eq("+0+")").click(function(){
				scrollPage($('.pp-section').eq(8));
			});
			$(".update_menu .m6 .depth2:eq("+1+")").click(function(){
				scrollPage($('.pp-section').eq(9));
			});
			$(".update_menu .m7 > a, .update_menu .m7 .depth2:eq("+0+")").click(function(){
				scrollPage($('.pp-section').eq(10));
			});
			$(".update_menu .m7 .depth2:eq("+1+")").click(function(){
				scrollPage($('.pp-section').eq(11));
			});
		}
